...
const UpperMenu = ({ onClick }) => {
  return (
    <Menu>
      ...
      <Menu.Item key="3">
        <NavLink onClick={onClick} activeClassName="active" to="/docs">
          Docs
        </NavLink>
      </Menu.Item>
      <Menu.Item key="4">
        <NavLink onClick={onClick} activeClassName="active" to="/liquid">
          Liquid
        </NavLink>
      </Menu.Item>
      <Menu.Item key="5">
        <NavLink onClick={onClick} activeClassName="active" to="/exchange">
          Exchange
        </NavLink>
      </Menu.Item>
      <Menu.Item key="6">
        <NavLink onClick={onClick} activeClassName="active" to="/lending">
          Lending
        </NavLink>
      </Menu.Item>
      <Menu.Item key="7">
        <NavLink onClick={onClick} activeClassName="active" to="/contact">
          Contact
        </NavLink>
      </Menu.Item>
    </Menu>
